...
/**
 * Identity model for the API Gateway request context. This is used in the
 * default AwsProxyRequest object. Contains
 * all of the properties declared in the $context.identity API Gateway object so
