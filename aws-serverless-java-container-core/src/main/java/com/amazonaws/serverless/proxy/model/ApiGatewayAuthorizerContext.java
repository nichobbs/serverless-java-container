 ...
 *
 * Custom authorizers populate the <code>principalId</code> field. All other
 * custom values
 * returned by the authorizer are accessible via the
 * <code>getContextValue</code> method.
 *
